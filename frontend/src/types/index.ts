...
export interface Mood {id:number;user_id:number;mood_level:number;mood_tags:string;note:string;record_date:string;journal_id?:number;created_at:string}
...
export interface Journal {id:number;title:string;content:string;mood_level:number;mood_tags?:MoodTag[];weather:string;is_private:boolean;linked_mood?:Mood|null;day_has_mood?:boolean;created_at:string;updated_at:string}
