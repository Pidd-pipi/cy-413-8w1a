...
const (
	...
	LogMoodCreatedFromJournal = "Mood auto-created from journal"
	LogMoodSyncedFromJournal  = "Mood synced from journal edit"
	LogMoodKeptManual         = "Mood manually maintained, left untouched by journal"
