...
const (
	...
	LogMoodLinkedFromJournal   = "Mood auto-created and linked from journal"
	LogMoodSyncedFromJournal   = "Mood synced from linked journal"
	LogMoodDetachedFromJournal = "Mood detached from journal after manual edit"
